...
class SemanticReRanker:
    ...
    def _detect_mismatch_severity(self, candidate, query):
        ...
        concept_conflicts = [
            {
                'query_concepts': ['báo cáo khối lượng công việc', 'báo cáo nhiệm vụ sinh viên'],
        ...
        context_checks = [
            {
                'query_pattern': ['sinh viên', 'mình là sinh viên'],
                'answer_wrong': ['chỉ dành cho giảng viên', 'giảng viên cần'],
