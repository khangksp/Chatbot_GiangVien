...
def home_view(request):
    ...
    return JsonResponse({
        ...
        'endpoints': {
            ...
            'ai_models': '/api/ai_models/',  # ✅ Agent System endpoints
            'agent_status': '/api/ai_models/agent/status/',  # ✅ Agent status
            'api_docs': '/api/',
        },
        'personalization': {
            'enabled': True,
...
urlpatterns = [
    ...
    path('api/ai_models/', include('ai_models.urls')),  # ✅ Agent System endpoints
]
